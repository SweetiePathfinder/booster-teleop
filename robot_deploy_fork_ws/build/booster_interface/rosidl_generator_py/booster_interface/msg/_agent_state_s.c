...
bool booster_interface__msg__agent_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("booster_interface.msg._agent_state.AgentState", full_classname_dest, 45) == 0);
  }
  booster_interface__msg__AgentState * ros_message = _ros_message;
  {  // agent_id
...
PyObject * booster_interface__msg__agent_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("booster_interface.msg._agent_state");
